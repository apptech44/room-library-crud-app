...
public class AddBooks extends AppCompatActivity {
    ...
    private void insertBooks() {
        ...
        if (book_name.isEmpty()) {
            SimpleToast.warning(AddBooks.this, "enter book name ...");
            return;
        }

        if (author_name.isEmpty()) {
            SimpleToast.warning(AddBooks.this, "enter author name ...");
            return;
        }

        if (book_price.isEmpty()) {
            SimpleToast.warning(AddBooks.this, "enter book price ...");
            return;
        }

        if (book_details.isEmpty()) {
            SimpleToast.warning(AddBooks.this, "enter book detail ...");
            return;
        }
